...
export default function ErrorPage() {
  ...
  return (
    <div className="flex flex-col min-h-[100dvh] bg-black text-white">
      <Helmet>
        <title>404 - Strona nie znaleziona | SWT Labs</title>
        <meta name="description" content="Nie możemy znaleźć strony, której szukasz. Sprawdź adres URL lub wróć do strony głównej." />
        <meta property="og:title" content="404 - Strona nie znaleziona | SWT Labs" />
        <meta property="og:description" content="Nie możemy znaleźć strony, której szukasz. Sprawdź adres URL lub wróć do strony głównej." />
        ...
        <link rel="canonical" href="https://swtlabs.pl/404" />
      </Helmet>
