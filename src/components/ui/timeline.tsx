...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20 pt-auto">
        {data.map((item, index) => (
          <motion.div
            key={index}
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-[#f2ccd6] via-[#f9c992] to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
